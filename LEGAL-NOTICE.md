...
部署完成后，DataFusionX Enterprise 支持 180 天试用授权。试用期内可以完整体验产品能力，包括项目治理、连接管理、CDC / Batch 同步、SQL 作业、审批、调度、运行中心、诊断中心、DDL 卫士、告警、审计和系统健康等功能。

180 天试用期结束后，如仍希望继续使用，或希望扩大到更多用户、更多实例、长期生产环境、离线环境或正式商业场景，请联系作者 Lynn-Lee 获取继续使用授权。
...
- 复制、出租、转让、托管、二次销售或二次分发 DataFusionX Enterprise 用户部署包。
