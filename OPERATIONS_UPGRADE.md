...
```text
DATAFUSIONX_VERSION=3.0.1
DATAFUSIONX_BACKEND_IMAGE=ghcr.io/lynn-lee/datafusionx-backend:3.0.1
DATAFUSIONX_FRONTEND_IMAGE=ghcr.io/lynn-lee/datafusionx-frontend:3.0.1
```
